...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post beers_url, params: { beer: { abv: @beer.abv, bewery_id: @beer.bewery_id, description: @beer.description, name: @beer.name, style_id: @beer.style_id } }
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { abv: @beer.abv, bewery_id: @beer.bewery_id, description: @beer.description, name: @beer.name, style_id: @beer.style_id } }
